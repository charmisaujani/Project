...
Original file is located at
    https://colab.research.google.com/drive/15DOrjDhXtJzEfo-YAWX6ELTc4TxJY2OG
"""
...
def implied_vol(S0, K, T, r, market_price, flag='c', tol=0.00001):  #tol is tolerance
    ...
    for k in range(max_iter):
        bs_price = bs(flag, S0, K, T, r, vol_old) #black scholes price
        Cprime =  vega(flag, S0, K, T, r, vol_old)*100  # * 100 because vega gives sensitivity to 1% change inbuilt
